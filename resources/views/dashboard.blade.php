<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('CITRA WEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDIIIIIING') }}
        </h2>
    </x-slot>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V4m0 4h.01m-6.938 4h7.178A2 2 0 0016 12v4a2 2 0 002 2h4v-4a2 2 0 00-2-2H8a2 2 0 00-2 2v4a2 2 0 002 2h7.178A2 2 0 0012 16v-4z" />
                                </svg>
                            </div>
                            <div class="ml-4">
